  ...
  es: {
    ...
    rows: [
      ...
      },
      {
        ...
        desc: "Producto digital · Interfaces · Ingeniería",
        status: "Entregado",
        live: false,
      },
    ],
  ...
  en: {
    ...
    rows: [
      ...
      },
      {
        ...
        desc: "Digital product · Interfaces · Engineering",
        status: "Delivered",
        live: false,
      },
    ],
...
/** Micro fragment — a tiny matching line (property ↔ client). */
...
/** Micro fragment — a tiny payment route (USDC → settlement). */
...
const FRAGMENTS = { matching: MatchingFragment, payment: PaymentFragment };

/**
 * /work hero visual — a systems overview board: one main translucent
 * plane with four horizontal project records separated by thin
 * lines, verified statuses and two tiny abstract system fragments.
 * No dashboards, no floating cards, no copied home hero.
 */
export default function WorkSystemsBoard({ lang = "es" }) {
  const t = T[lang];
