...
/**
 * Service hero — commercial, not a case study. Copy left; on the right
 * the real operating model of the CRM we build: ten domains around one
 * core, with the events the system actually raises.
 */
export default function CrmServiceHero({ lang, c, proofPath }) {
  const h = c.hero;
  return (
    <header id="crm-service-hero" className="mx-auto grid max-w-[1440px] items-center gap-12 overflow-x-clip px-5 pb-12 pt-8 md:px-10 md:pb-16 md:pt-12 lg:grid-cols-12 lg:gap-8">
      ...
      <Reveal eager variant="scale" delay={0.1} className="min-w-0 md:mx-auto md:w-full md:max-w-[600px] lg:col-span-7 lg:max-w-none lg:pl-4">
