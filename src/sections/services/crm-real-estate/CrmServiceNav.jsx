...
/**
 * Local chapter navigation — a thin sticky rail on desktop only. It
 * follows the reader with IntersectionObserver (no scroll listeners)
 * and stays out of the way: mono labels, one accent underline.
 */
export default function CrmServiceNav({ items, label }) {
  ...
  return (
    <nav aria-label={label} className="sticky top-[56px] z-30 hidden border-y border-border bg-white/85 backdrop-blur-md lg:block">
