...
export default function TransitionBridge() {
  return (
    <div aria-hidden="true" className="relative h-[20vh] overflow-hidden md:h-[24vh]">
      ...
      <span className="absolute left-1/2 top-1/2 h-[26vh] w-[52vw] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(closest-side,rgba(49,87,246,0.10),transparent)]" />
      ...
      <motion.span
        ...
        className="absolute left-[10%] right-[10%] top-1/2 h-px origin-left bg-gradient-to-r from-transparent via-[#3157F6]/60 to-transparent blur-[0.5px]"
      />
    </div>
  );
}