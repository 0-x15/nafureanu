...
/**
 * The problem — a two-part headline with a conceptual operational-
 * tension visual, then eight numbered problems whose real solutions
 * appear in a floating organic bubble on hover, focus or tap.
 */
export default function CrmProblem({ c, lang = "es" }) {
  ...
  return (
    <section className="mx-auto max-w-[1440px] px-5 py-16 md:px-10 md:py-24">
      {/* Top — headline left, conceptual visual right */}
      <div className="md:grid md:grid-cols-12 md:items-center md:gap-16">
        ...
        <div className="mt-14 md:col-span-5 md:mt-0">
      ...
      {/* Bottom — problems left, organic solution bubble right */}
