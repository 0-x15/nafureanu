export const ES = {
  ...
  crm: {
    ...
    gallery: {
      ...
      title: "No te lo contamos. Puedes probarlo.",
      copy: "Explora una demostración interactiva del CRM con datos ficticios y descubre cómo inmuebles, clientes, demandas, visitas y operaciones trabajan dentro del mismo sistema.",
      badge: "CRM inmobiliario · Demo interactiva",
      env: "Entorno de demostración",
      cta: "Abrir demo CRM",
      meta: "8 áreas conectadas · datos ficticios · sin registro",
      preview: {
        nav: ["Panel", "Inmuebles", "Contactos", "Demandas", "Matching", "Agenda", "Visitas", "Operaciones", "Documentos"],
        title: "Panel",
        kpis: [["Demandas nuevas", "1"], ["Visitas próximas", "3"], ["Operaciones abiertas", "2"], ["Documentos pendientes", "6"]],
        pipeline: "Pipeline comercial",
        stages: ["Nuevo", "Contactado", "Cualificado", "Visitando", "Negociando", "Ganado"],
        activity: "Actividad reciente",
        lines: ["Visita programada · DEMO-P001", "Documento aprobado · Nota simple", "DEMO-O001 avanzó a Arras", "Nuevo lead recibido desde portal"],
      },
    },
    cta: {
