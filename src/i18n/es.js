export const ES = {
  ...
  build: {
    ...
    intro:
      "Seis áreas, una misma forma de trabajar: primero entender el proceso de negocio, después construir el sistema que lo ejecuta.",
    groups: [
      {
        name: "Software",
        desc: "Plataformas a medida, SaaS y herramientas internas.",
        items: "Plataformas · SaaS · Dashboards · Apps",
      },
      {
        name: "Automatización e IA",
        desc: "Procesos, agentes, asistentes IA y automatización operativa.",
        items: "Asistentes IA · Workflows · Documentos",
      },
      {
        name: "Sistemas de negocio",
        desc: "CRM, ERP, Odoo y operaciones internas digitalizadas.",
        items: "CRM · ERP · Odoo · Operaciones",
      },
      {
        name: "Integraciones",
        desc: "APIs, bots y datos que se mueven entre sistemas.",
        items: "APIs · Webhooks · Bots · Datos",
      },
      {
        name: "Productos digitales",
        desc: "Webs corporativas, aplicaciones y experiencias.",
        items: "Webs · Aplicaciones · Experiencias",
      },
      {
        name: "Infraestructura avanzada",
        desc: "Pagos con stablecoins, Web3 y backends complejos.",
