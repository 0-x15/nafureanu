export const ES = {
  ...
  workSection: {
    ...
    sophia: {
      ...
      headlineA: "40.000+ propiedades.",
      headlineB: "Una operación.",
      copy: "SophIA centraliza operaciones inmobiliarias, clientes, propiedades, matching, inteligencia artificial e integraciones dentro de un sistema construido sobre Odoo.",
      proof: [
      ...
      shows:
        "Podemos modelar una operación compleja y convertirla en un sistema que centraliza datos, automatiza decisiones y conecta herramientas.",
    ...
    fivo: {
      ...
      headlineA: "9 redes.",
      headlineB: "Una integración.",
      copy: "Fivo abstrae la complejidad de los pagos con USDC y EURC para que comercios y desarrolladores trabajen con una experiencia única mientras la infraestructura resuelve liquidación, verificación y movimiento cross-chain detrás.",
      proof: [{ value: "9", label: "Redes blockchain" }],
      caps: [
        "USDC / EURC",
        "Checkout embebible",
        "Payment links",
      ...
      showsKicker: "Lo que demuestra",
      shows:
        "Podemos construir producto, API e infraestructura financiera compleja detrás de una experiencia sencilla.",
      cta: "Ver caso completo",
      scene: {
        title: "Liquidación",
