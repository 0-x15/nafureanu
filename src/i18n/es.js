...
curl -X POST https://api.fivo.finance/refunds/api/create \
  ...
  crmService: {
    meta: {
      ...
      description:
        "Diseñamos CRM inmobiliarios a medida alrededor de la operación real de cada empresa: propiedades, clientes, demanda, matching, visitas, automatización, documentación e integraciones.",
    },
    hero: {
      kicker: "CRM inmobiliario a medida",
      title: "Un CRM que trabaja como trabaja tu inmobiliaria.",
      support:
        "Diseñamos sistemas CRM a medida para centralizar propiedades, clientes, demanda, captación, visitas, operaciones, documentación y comunicación — automatizando el trabajo que hoy depende del equipo.",
      secondary:
        "No partimos de un CRM estándar para intentar encajar tu proceso. Primero entendemos cómo funciona la inmobiliaria y después diseñamos el sistema alrededor de esa operación.",
      primary: "Hablar sobre mi CRM",
      proof: "Ver un proyecto real",
      visualLabel: "Una operación inmobiliaria conectada: la ficha de un inmueble unida a demanda, cliente, matching, visita, operación, documentos y portales",
      center: { label: "Inmueble", title: "Piso · 3 habitaciones", meta: ["Centro", "92 m²", "285.000 €"], status: "Disponible", published: "Publicado" },
      nodes: [
        { id: "demand", label: "Demanda", detail: "2 demandas compatibles" },
        { id: "client", label: "Cliente", detail: "Llamada registrada" },
        { id: "matching", label: "Matching", detail: "Cruce automático" },
        { id: "visit", label: "Visita", detail: "Programada · jueves" },
        { id: "operation", label: "Operación", detail: "En negociación" },
        { id: "documents", label: "Documentos", detail: "3 de 5 revisados" },
        { id: "portals", label: "Portales", detail: "Idealista · Fotocasa" },
      ],
      note: "Ejemplo conceptual con datos ficticios",
    },
    problems: {
      kicker: "El problema real",
      titleA: "Un CRM genérico registra datos.",
      titleB: "Una inmobiliaria necesita que el sistema entienda cómo trabaja.",
      intro: "Si reconoces varias de estas situaciones, el problema no es el equipo: es que el sistema no entiende la operación.",
      capabilityLabel: "Lo que el sistema puede hacer",
      items: [
        { problem: "Leads que nadie atiende a tiempo.", capability: "Control del primer contacto con plazos y avisos" },
        { problem: "Matching entre clientes e inmuebles hecho a mano.", capability: "Cruce automático de demanda e inmuebles" },
        { problem: "Información duplicada entre herramientas.", capability: "Contacto unificado y detección de duplicados" },
        { problem: "Portales que hay que actualizar por separado.", capability: "Publicación conectada a la ficha del inmueble" },
        { problem: "Visitas y calendario desconectados del CRM.", capability: "Agenda operativa dentro del sistema" },
        { problem: "Documentación que depende de revisión manual.", capability: "Documentos como parte del workflow" },
        { problem: "Seguimientos que dependen de que alguien los recuerde.", capability: "Tareas, alertas y recordatorios automáticos" },
        { problem: "WhatsApp y llamadas fuera del contexto del cliente.", capability: "Comunicación vinculada al contacto" },
      ],
    },
    system: {
      kicker: "Qué podemos construir",
      title: "Un sistema alrededor de toda la operación inmobiliaria.",
      intro: "Cada CRM se diseña según el proceso de la empresa. Estas son las áreas que un sistema de este tipo puede cubrir, conectadas entre sí.",
      hint: "Selecciona un área",
      connectedLabel: "Conectado con",
      closing: "La información no solo queda centralizada: cada parte del sistema conoce su relación con las demás.",
      areas: [
        { id: "properties", title: "Propiedades", descriptor: "La ficha operativa de cada inmueble", items: ["Ficha del inmueble", "Estado", "Precio", "Documentación", "Disponibilidad", "Estado en portales"], connections: ["Matching", "Visitas", "Operaciones", "Portales"] },
        { id: "clients", title: "Clientes y demanda", descriptor: "Cada contacto y lo que busca", items: ["Contactos", "Compradores", "Vendedores", "Propietarios", "Inquilinos", "Criterios de búsqueda"], connections: ["Matching", "Comunicación", "Visitas"] },
        { id: "leads", title: "Captación y leads", descriptor: "De la oportunidad al primer contacto", items: ["Prospectos", "Asignación de leads", "Seguimiento", "Control del primer contacto"], connections: ["Agenda", "Alertas", "Clientes"] },
        { id: "matching", title: "Matching", descriptor: "Demanda e inmuebles cruzados automáticamente", items: ["Demanda ↔ inmueble", "Oportunidades compatibles", "Preparación de visitas"], connections: ["Propiedades", "Clientes", "Visitas"] },
        { id: "operations", title: "Visitas y operaciones", descriptor: "De la visita al cierre", items: ["Visitas", "Seguimiento", "Negociación", "Arras", "Financiación", "Escritura", "Postventa"], connections: ["Documentación", "Agenda", "Clientes"] },
        { id: "documents", title: "Documentación", descriptor: "Documentos dentro del proceso", items: ["Requisitos", "Revisión", "Aprobación", "Firma", "Checklists"], connections: ["Operaciones", "Propiedades"] },
        { id: "communication", title: "Comunicación", descriptor: "Conversaciones en el contexto del cliente", items: ["WhatsApp", "Llamadas", "Historial del cliente"], connections: ["Clientes", "Leads", "Agenda"] },
        { id: "calendar", title: "Agenda y tareas", descriptor: "La operación diaria del equipo", items: ["Tareas", "Visitas", "Llamadas", "Recordatorios", "Sincronización de calendario"], connections: ["Visitas", "Leads", "Comunicación"] },
      ],
    },
    automation: {
      kicker: "Automatización",
      ...
      intro: "Según cómo funcione la operación, el sistema puede automatizar tareas que hoy dependen del equipo. Algunos ejemplos que ya hemos construido:",
      stages: ["Evento", "Lógica del sistema", "Acción automática", "Resultado"],
      lanes: [
        { id: "matching", title: "Matching automático", text: "Cruza demanda e inmuebles y detecta coincidencias sin búsqueda manual.", flow: ["Nueva demanda", "Criterios comparados", "Cruce con inmuebles compatibles", "Oportunidades detectadas"] },
        { id: "leads", title: "Seguimiento de leads", text: "Controla el primer contacto, la actividad y los seguimientos para que ninguna oportunidad quede sin atender.", flow: ["Lead asignado", "Plazo de primer contacto", "Aviso al responsable", "Lead atendido o devuelto a la cola"] },
        { id: "checklists", title: "Checklists inteligentes", text: "Los requisitos de un expediente se actualizan cuando el sistema detecta que un paso ya se ha cumplido.", flow: ["Documento recibido", "Requisito verificado", "Checklist actualizada", "El expediente avanza"] },
        { id: "alerts", title: "Alertas y recordatorios", text: "Vencimientos, inactividad y tareas pendientes sin depender de la memoria del equipo.", flow: ["Vencimiento próximo", "Estado comprobado", "Recordatorio creado", "Nada se olvida"] },
        { id: "sync", title: "Sincronización de operaciones", text: "Los eventos relevantes mantienen conectados el CRM, la agenda y las integraciones de cada proceso.", flow: ["Visita programada", "Evento propagado", "Calendario y CRM actualizados", "Una sola agenda"] },
        { id: "ai", title: "Cualificación asistida por IA", text: "Conversaciones y llamadas pueden convertirse en contactos, demandas o información estructurada.", flow: ["Conversación recibida", "Información extraída", "Contacto o demanda creada", "Lead cualificado"] },
      ],
      note: "Cada automatización se diseña sobre las reglas de la empresa. La IA asiste dentro del proceso; no sustituye la lógica del negocio.",
    },
    matching: {
      kicker: "Matching",
      title: "Demanda e inmuebles cruzados automáticamente, en las dos direcciones.",
      paras: [
        "Desde una demanda, el sistema encuentra los inmuebles compatibles. Desde un inmueble, detecta los clientes que podrían estar interesados. Evalúa los criterios relevantes de cada caso y prepara el siguiente paso, como una visita.",
        "Este es el tipo de lógica operativa que podemos construir dentro del CRM, adaptada a los criterios con los que trabaja cada inmobiliaria.",
      ],
    ...
    integrations: {
      kicker: "Integraciones",
      title: "El CRM debería conectar las herramientas que la inmobiliaria ya usa.",
      intro: "Portales, comunicación, agenda y firma pueden formar parte del mismo sistema. Qué se integra depende de cada proyecto.",
      core: "CRM inmobiliario",
      coreState: "Sistema conectado",
      groups: [
        { id: "portals", title: "Portales", items: [
          { name: "Idealista", role: "Publicar, actualizar y retirar inmuebles", direction: "CRM → portal" },
          { name: "Fotocasa", role: "Publicación y entrada de leads", direction: "CRM ↔ portal" },
          { name: "MLS", role: "Publicación y sincronización con la red", direction: "CRM ↔ red" },
        ] },
        { id: "communication", title: "Comunicación", items: [
          { name: "WhatsApp", role: "Mensajes en el contexto del cliente", direction: "cliente ↔ CRM" },
        ] },
        { id: "operation", title: "Operación", items: [
          { name: "Google Calendar", role: "Tareas, visitas y llamadas sincronizadas", direction: "CRM ↔ agenda" },
          { name: "Odoo Sign", role: "Firma dentro del workflow documental", direction: "CRM → firma" },
        ] },
      ],
    ...
    architecture: {
      ...
      copy: "Para algunas operaciones, Odoo es una base excelente: ya aporta usuarios, permisos, estructuras de CRM y extensibilidad, y sobre ella construimos modelos, lógica e interfaz a medida. En otros casos tiene más sentido una arquitectura propia. Elegimos la base técnica según el proceso, las integraciones, la escala y la evolución que necesita el sistema.",
      options: [
        { title: "Odoo como base", text: "Cuando la operación encaja con su estructura: módulos a medida, lógica en Python, interfaces propias e integraciones sobre una plataforma probada." },
        { title: "Arquitectura a medida", text: "Cuando el proceso, la escala o las integraciones piden otra cosa: aplicación web propia, base de datos diseñada para la operación y APIs." },
      ],
      toolsLabel: "Con qué trabajamos",
      tools: ["Ingeniería Odoo", "Módulos a medida", "Lógica en Python", "APIs", "Aplicaciones web a medida", "Bases de datos", "Integraciones externas"],
    ...
    proof: {
      ...
      copy: "En uno de nuestros proyectos, una operación inmobiliaria completa fue convertida en un sistema a medida que conecta propiedades, clientes, demanda, matching, visitas, documentación, comunicación, automatización e integraciones.",
      linkLabel: "Caso real",
    ...
    fit: {
      kicker: "¿Para quién?",
      title: "¿Cuándo tiene sentido construir un CRM a medida?",
      signals: [
        "Cuando el CRM actual obliga al equipo a trabajar alrededor de él.",
        "Cuando los datos y los procesos viven repartidos en varias herramientas.",
        "Cuando el matching, el seguimiento o las operaciones dependen demasiado de la memoria y del trabajo manual.",
        "Cuando la inmobiliaria tiene formas de trabajar propias que el software genérico no puede modelar.",
        "Cuando las integraciones (portales, comunicación, agenda, firma) se están volviendo centrales en la operación.",
        "Cuando el crecimiento está creando complejidad operativa.",
      ],
    ...
    scope: {
      ...
      items: [
        { title: "Descubrimiento", text: "Mapa del proceso real de la inmobiliaria." },
        { title: "Arquitectura del sistema", text: "Estructura, base técnica y límites del sistema." },
        { title: "Modelo de datos del CRM", text: "Inmuebles, clientes, demandas, visitas, operaciones y documentos." },
        { title: "Flujos a medida", text: "Estados, reglas y dependencias de cada proceso." },
        { title: "Automatización", text: "Trabajo que el sistema ejecuta por sí mismo." },
        { title: "IA donde aporte", text: "Cualificación, extracción de información y conversación." },
        { title: "Integraciones", text: "Portales, comunicación, agenda y firma." },
        { title: "Migración", text: "Datos y procesos que vienen de las herramientas actuales." },
        { title: "Dashboards e informes", text: "Lectura operativa de la actividad." },
        { title: "Despliegue", text: "Puesta en producción y acompañamiento del equipo." },
        { title: "Documentación", text: "Del sistema y de cómo se usa." },
        { title: "Mantenimiento y evolución", text: "El sistema cambia cuando cambia la operación." },
      ],
    },
    process: {
      kicker: "Cómo abordamos el proyecto",
      title: "Un proyecto estructurado, empezando por la operación.",
      steps: [
        { title: "Entender la operación", text: "Cómo trabaja hoy la inmobiliaria: personas, herramientas, información y tiempos." },
        { title: "Mapear entidades, estados y flujos", text: "Inmuebles, clientes, demandas, visitas, operaciones y documentos, con sus estados y dependencias." },
        { title: "Diseñar la arquitectura", text: "Modelo de datos, lógica, automatizaciones, integraciones y base técnica." },
        { title: "Construir e integrar", text: "Desarrollo del sistema y conexión con portales, comunicación, agenda y firma." },
        { title: "Migrar y validar", text: "Si procede, traslado de datos y validación con el equipo sobre casos reales." },
        { title: "Desplegar y evolucionar", text: "Puesta en producción, acompañamiento y evolución según cambia la operación." },
      ],
    },
    cta: {
      kicker: "Tu operación",
      title: "Si tu equipo trabaja alrededor del CRM, probablemente el CRM debería cambiar.",
      copy: "Cuéntanos cómo gestionáis hoy propiedades, clientes, demanda, visitas, operaciones y seguimiento. Empezaremos por entender el proceso y veremos qué sistema tendría sentido construir.",
      primary: "Hablar sobre mi CRM",
