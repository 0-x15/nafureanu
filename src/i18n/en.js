export const EN = {
  ...
  crm: {
    ...
    gallery: {
      ...
      title: "Don't just take our word for it. Try it.",
      copy: "Explore an interactive CRM demo with fictional data and see how properties, clients, demand, visits and operations work inside the same system.",
      badge: "Real-estate CRM · Interactive demo",
      env: "Demo environment",
      cta: "Open CRM demo",
      meta: "8 connected areas · fictional data · no sign-up",
      preview: {
        nav: ["Dashboard", "Properties", "Contacts", "Demand", "Matching", "Calendar", "Visits", "Operations", "Documents"],
        title: "Dashboard",
        kpis: [["New demand", "1"], ["Upcoming visits", "3"], ["Open operations", "2"], ["Pending documents", "6"]],
        pipeline: "Commercial pipeline",
        stages: ["New", "Contacted", "Qualified", "Visiting", "Negotiating", "Won"],
        activity: "Recent activity",
        lines: ["Visit scheduled · DEMO-P001", "Document approved · Land registry extract", "DEMO-O001 moved to Deposit", "New lead received from portal"],
      },
    },
    cta: {
